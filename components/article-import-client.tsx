      ...
      {showHelp && (
        <div className="rounded-xl border border-blue-200 bg-blue-50 p-5 mb-6 animate-in fade-in slide-in-from-top-2 duration-300">
          ...
          <p className="text-xs text-blue-600 mt-3">
            Для итераций 1-4 ИИ выводит значения по умолчанию. Вы сможете
            выбрать отрасль и категорию в редакторе после импорта.
          </p>
        </div>
      )}
          ...
          {templateIter.isPlaceholder && (
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-3 mb-4">
              <p className="text-xs text-blue-700">
                Эта итерация заполняется значением по умолчанию. Вы сможете
                выбрать отрасль, категорию и другие параметры в редакторе после
                импорта.
              </p>
            </div>
          )}
